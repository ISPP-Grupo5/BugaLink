...
urlpatterns = [
    ...
    path('users/<int:user_id>/passenger-routine/<int:routine_id>', views.PassengerRoutine.as_view()),
    path('users/<int:user_id>/driver-routine/<int:routine_id>', views.DriverRoutine.as_view()),
