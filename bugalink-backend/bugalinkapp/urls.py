...
urlpatterns = [
    ...
    path('users/passenger-routines/<int:routine_id>', views.PassengerRoutine.as_view()),
    path('users/driver-routines/<int:routine_id>', views.DriverRoutine.as_view()),
    ...
    path('test/users/passenger-routines/<int:routine_id>', views.PassengerRoutine.as_view()),
    path('test/users/driver-routines/<int:routine_id>', views.DriverRoutine.as_view()),
]
