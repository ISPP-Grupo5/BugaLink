...
export default function DriverCard(){
    return(
        <Link href='#' className='scale-90 -translate-x-2 snap-center shrink-0 block shadow bg-green rounded-2xl hover:bg-gray-100 w-96' >
          <span className="bg-white relative rounded-2xl shadow-lg">
              ...
              <span className='bg-white flex pt-2 pb-2 rounded-2xl overflow-hidden'>           
                ...
                <div className='scale-90 -space-x-16 flex flex-row'>
                  ...
                  <img src="/icons/Vista-Principal/hombre.png" className='object-scale-down h-20 w-20 scale-75 z-20'/>
                  <img src="/icons/Vista-Principal/hombre.png" className='object-scale-down h-20 w-20 scale-75 z-10'/>
                  <img src="/icons/Vista-Principal/hombre.png" className='object-scale-down h-20 w-20 scale-75 z-0'/>
                  
                </div>

                <div className='text-left text-ellipsis overflow-hidden pt-5'>
                  <p className='text-sm text-gray'>Pasajeros</p> 
                  <p className='text-sm text-black font-bold'>Juan Blanco y 2 más...</p>
                </div>
