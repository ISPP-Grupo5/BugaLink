...
import { BackButtonText } from '../../../../../components/buttons/Back/index';
  ...
  return (
    <div className="flex justify-center h-screen bg-base">
      ...
      <div className="w-11/12 bg-white pb-44">
        {/* Profile header */}
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', marginTop: '20px' }} className="flex flex-row items-center justify-between px-5 py-2 pt-20">
        ...
        {/* User */}
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', marginTop: '20px' }} className="grid grid-cols-2 px-5 py-2 gap-2">
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', marginTop: '20px' }}>
          <div style={{ display: 'flex', justifyContent: 'center' }}>
            {[...Array(5)].map((star, i) => {
              ...
              return (
                <label key={i} style={{ cursor: 'pointer', fontSize: '50px', margin: '0 5px', color: ratingValue <= rating ? '#ffc107' : 'gray' }}>
                  <input
                    type="radio"
                    name="rating"
                    value={ratingValue}
          ...
          <h2 style={{ fontSize: '14px', marginBottom: '10px' }}>No te preocupes, las valoraciones son anónimas</h2>
          ...
          <div>
            <div style= {{ display : 'flex', flexDirection: 'row'}}>
              ...
              >
                <img style={{ margin: 'auto' }} src="/assets/mocks/rueda.png" alt="Button 1" />
              </button>
              <button
                style={{
                  borderRadius: '50%',
              ...
              >
                <img style={{ margin: 'auto' }} src="/assets/mocks/cara.png" alt="Button 2" />
              </button>
              <button
                style={{
                  borderRadius: '50%',
              ...
              >
                <img style={{ margin: 'auto' }} src="/assets/mocks/mano.png" alt="Button 3" />
              </button>
            </div>
          </div>
